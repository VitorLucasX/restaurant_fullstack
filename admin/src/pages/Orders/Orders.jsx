              ...
              {order.address && (
                <>
                  ...
                  <div className="order-item-address">
                    ...
                    <p>{order.address.city && order.address.city + ", "}{order.address.state && order.address.state + ", "}{order.address.country && order.address.country + ", "}{order.address.zipcode && order.address.zipcode}</p>
                  </div>
